...
from .geom import BALL as B, D, DOT, Rect, S, So, rotate180, soft, solve, widen
...
def _raw_p():
    ...
    g["i"] = S((1.5, 0), (1.5, 10)) | D((1.5, -3.5), DOT)
    g["j"] = S((4, 0), (4, 13), (1, 13, B)) | D((4, -3.5), DOT)
...
def _raw_m_rebuilt():
    g = {}
    g["i"] = S((2, 1, B), (4.5, 1, 0), (4.5, 9)) | S((1, 9), (8, 9)) | D((4.5, -3.5), DOT)
    g["l"] = S((2, -3, B), (4.5, -3, 0), (4.5, 9), (8, 9, B))
    g["j"] = S((3, 1, B), (6, 1, 0), (6, 13), (1, 13, B)) | D((6, -3.5), DOT)
