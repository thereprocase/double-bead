...
def symbols(fig):
    ...
    s[":"] = D((1.5, 1.5), DOT) | D((1.5, 8.5), DOT)
    s[";"] = D((1.7, 1.5), DOT) | comma
    s["<"] = S((6, -1, B), (1, 3), (6, 7, B))
    s["="] = S((0.5, 0.5), (6.5, 0.5)) | S((0.5, 5.5), (6.5, 5.5))
    s[">"] = mirror_x(s["<"], 7)
    s["?"] = S((1, -3, B), (6, -3), (6, 2), (3.5, 2), (3.5, 5)) | D((3.5, 8.5), DOT)
    ...
    s["¡"] = D((1.5, 1.5), DOT) | S((1.5, 5), (1.5, 14))
    s["¿"] = rotate180(s["?"], (3.5, 5))
    ...
    s["÷"] = S((0, 3), (6, 3)) | D((3, -1.5), DOT) | D((3, 7.5), DOT)
    ...
    s["…"] = D((1.5, 8.5), DOT) | D((6.5, 8.5), DOT) | D((11.5, 8.5), DOT)
...
def specials(p, cap, sym):
    ...
    x["ŀ"] = p["l"] | D((5.5, 5), DOT)                                  # r1: middle dot at mid x-height
    x["Ŀ"] = cap["L"] | D((5.5, 3), DOT)
